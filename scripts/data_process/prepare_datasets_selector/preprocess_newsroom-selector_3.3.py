...
split = 'dev'
with open('../recsum_/data/newsroom/selector/%s-selector-2.3.json' % split) as f:
    lines = f.readlines()
...
with jsonlines.open('../recsum_/data/newsroom/selector/%s-selector-3.3.json' % split, 'w') as f:
